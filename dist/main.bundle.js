...
const CDN_BASE = `https://cdn.jsdelivr.net/gh/Fahell/test-perchance-git@v1.26.14`;
...
function initUITest(rendererData, testModules) {
  ...
  async function aiImagePlaintextContextHandler() {
    ...
    const result = await aiImageTest2.testPlaintextAndContext(contentArea);
    if (!(result == null ? void 0 : result.success)) {
      contentArea.innerHTML = `<div style="color:#ff6b6b;padding:10px;">❌ Error: ${(result == null ? void 0 : result.error) || "Test failed"}</div>`;
      throw new Error((result == null ? void 0 : result.error) || "Test failed");
    }
  ...
  async function aiImagePreprocessAllHandler() {
    ...
    const result = await aiImageTest2.testPreprocessAllHook(contentArea);
    if (!(result == null ? void 0 : result.success)) {
      contentArea.innerHTML = `<div style="color:#ff6b6b;padding:10px;">❌ Error: ${(result == null ? void 0 : result.error) || "Test failed"}</div>`;
      throw new Error((result == null ? void 0 : result.error) || "Test failed");
    }
  ...
  async function aiImageHtmlWrappersHandler() {
    ...
    const result = await aiImageTest2.testHtmlWrappers(contentArea);
    if (!(result == null ? void 0 : result.success)) {
      contentArea.innerHTML = `<div style="color:#ff6b6b;padding:10px;">❌ Error: ${(result == null ? void 0 : result.error) || "Test failed"}</div>`;
      throw new Error((result == null ? void 0 : result.error) || "Test failed");
    }
  ...
  async function aiImageBatchHtmlWrappersHandler() {
    ...
    const result = await aiImageTest2.testBatchHtmlWrappers(contentArea);
    if (!(result == null ? void 0 : result.success)) {
      contentArea.innerHTML = `<div style="color:#ff6b6b;padding:10px;">❌ Error: ${(result == null ? void 0 : result.error) || "Test failed"}</div>`;
      throw new Error((result == null ? void 0 : result.error) || "Test failed");
    }

...
import { root, getVar, getList } from 'https://cdn.jsdelivr.net/gh/Fahell/test-perchance-git@v1.0.2/src/perchance-bridge.js';
import { initRenderer } from 'https://cdn.jsdelivr.net/gh/Fahell/test-perchance-git@v1.0.2/src/modules/renderer.js';
import { initLogic } from 'https://cdn.jsdelivr.net/gh/Fahell/test-perchance-git@v1.0.2/src/modules/logic.js';
...
export async function initGame() {
  ...
  try {
    ...
    try {
      const uiModule = await import('https://cdn.jsdelivr.net/gh/Fahell/test-perchance-git@v1.0.2/src/modules/ui-test.js');
